...
export default function CourseDetail() {
    return  <div className="course-details">
            ...
            <div className="w-50 m-auto d-flex justify-content-space-between my-5  gap-5 text-center align-items-center" >
                <NavLink to="" className="text-deco-none w-100"><button type="button" className="btn btn-danger w-100 d-block text-bold" >Documentation</button></NavLink>
                <NavLink to="/course-details/1" className="text-deco-none w-100"><button type="button"  className="btn w-100 btn-primary d-block text-bold">Add To My</button></NavLink>
            </div>
            <div className="my-5 ">
