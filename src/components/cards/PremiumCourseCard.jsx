...
export default function PremiumCourseCard() {
    ...
    return (
        <div className="card" style={{ width: "25rem" }}>
            <img src={`${process.env.PUBLIC_URL}/img/CSFunda/cn.png`} className="card-img-top" alt="..." />
            ...
            <div className="card-body d-flex ">
                ...
                <button type="button" className="btn btn-primary w-100 d-block text-bold" style={{ marginLeft: "auto" }}>Buy</button>
            </div>
        </div>
    )
}