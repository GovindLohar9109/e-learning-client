    ...
    return (
        <div className="card" >
            ...
            <ul className="list-group list-group-flush text-center align-items-center" >
                <li className="list-group-item w-100"><NavLink to="#" className="text-deco-none"><button type="button"  className="btn btn-danger  d-block text-bold" >Documentation</button></NavLink></li>
                <li className="list-group-item w-100"> <NavLink to={`/course/details/#`} className="text-deco-none"><button type="button" className="btn btn-secondary d-block text-bold">Details </button> </NavLink></li>
